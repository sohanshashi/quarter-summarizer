...
export function UsageCard({
  ...
  return (
    <div className="rounded-2xl bg-accent px-[24px] py-[28px] flex flex-col items-center text-center w-[250px] h-[330px] transition-all duration-300 ease-out hover:scale-[1.05] hover:shadow-lg hover:-translate-y-0.5">
